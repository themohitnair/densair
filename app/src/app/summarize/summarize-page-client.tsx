          ...
          <div className="container mx-auto px-4 py-8 md:py-16">
            ...
            <div className="max-w-2xl mx-auto mb-8">
              ...
              {arxivId && (
                <div className="mt-4 flex justify-center">
                  <Button
                    onClick={() =>
                      router.push(`/chat?id=${encodeURIComponent(arxivId)}`)
                    }
                    variant="outline"
                  >
              ...
              <div className="flex-1 flex items-center justify-center py-12">
                <div className="text-center p-8 bg-muted/50 rounded-lg">
                  ...
                  <p className="text-muted-foreground">
                    Enter an ArXiv ID above to start.
                  </p>
                </div>
              </div>
            )}
            ...
            {!loading && summaries && metadata && (
              <div className="max-w-6xl mx-auto space-y-8">
                ...
                <KeyTermsSection
                  terms={summaries.terms_and_summaries.key_terms}
                  fetchAugmenters={fetchAugmenters}
                />
                ...
                <SummarySection
                  ...
                  content={summaries.overall_summary.summary}
                />
                <SummarySection
                  title="Abstract"
                  content={summaries.terms_and_summaries.abs_explanation}
                />
                <SummarySection
                  title="Methodology"
                  content={summaries.terms_and_summaries.meth_explanation}
                />
                <SummarySection
                  title="Conclusions"
